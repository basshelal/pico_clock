#ifndef PICO_CLOCK_CUSTOM_FONT_HPP
#define PICO_CLOCK_CUSTOM_FONT_HPP

// Modified font because ":" character was ugly in the original,
// My ":" is much nice after some tweaking and testing

#pragma once

#include "font.hpp"

const pimoroni::Font custom_font{
        .height = 8,
        .max_width = 6,
        .widths = {
        ...
        .data = {
                ...
                0x66, 0x00, 0x00, 0x00, 0x00, 0x00, // : // originally 0x33, but looked too high 0x66 is same but lower
...
#endif //PICO_CLOCK_CUSTOM_FONT_HPP
